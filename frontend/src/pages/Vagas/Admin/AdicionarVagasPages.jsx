...
export default function AdicionarVagasPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch('http://localhost:4000/vaga', {
                method: 'POST',
                headers: {
    ...
    return (
        <section className="page">
            <h2>Formulário adicionar vagas</h2>
            ...
            <form className="form-vagas" onSubmit={handleSubmit}>
                ...
                <div className="form__btns-container">
                    <button type='submit' onClick={() => window.location.href = '/admin'}>
                        Publicar
                    </button>
                </div>
            </form>
